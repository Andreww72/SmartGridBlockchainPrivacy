...
print()
print("NN number accuracy: ", accuracy_score(Y_test_num, predictions_num_nn, normalize=True))
print("NN postcode accuracy: ", accuracy_score(Y_test_post, predictions_post_nn, normalize=True))
