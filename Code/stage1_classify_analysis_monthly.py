...
monthly_data = pd.read_csv('0_1a_combined_monthly_allnumeric.csv', header=0)
...
X_num = monthly_data.drop('Customer', axis=1)
Y_num = monthly_data['Customer']
X_post = monthly_data.drop('Postcode', axis=1)
Y_post = monthly_data['Postcode']
...
print("NN number monthly accuracy: ", accuracy_score(Y_test_num, predictions_num_nn, normalize=True))
print("NN postcode monthly accuracy: ", accuracy_score(Y_test_post, predictions_post_nn, normalize=True))
