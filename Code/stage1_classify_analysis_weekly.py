...
###################################
print("Classifying stage 1 weekly data")
...
print("NN number weekly accuracy: ", accuracy_score(Y_test_num, predictions_num_nn, normalize=True))
print("NN postcode weekly accuracy: ", accuracy_score(Y_test_post, predictions_post_nn, normalize=True))
